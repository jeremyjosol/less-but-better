...
public class SPH : MonoBehaviour
{
    ...
    // public Vector3 rotationSpeed = new Vector3(0, 0, 0); // Adjust as needed


    private void OnDrawGizmos() {

        Gizmos.color = Color.blue;
        // Matrix4x4 rotationMatrix = Matrix4x4.TRS(transform.position, Quaternion.Euler(rotationSpeed * Time.time), Vector3.one);
